...
def compare_item_against_user_rated(user_rated, target, items, user):
    results = {}
    similarities = 0
    ...
    for val in results.values():
        result += val
    result /= (0.0+similarities) #media ponderada pelas similarities
    return result
...
if __name__ == '__main__':
    ...
    score_prediction = compare_item_against_user_rated(user_rated_items, target, items, user)
